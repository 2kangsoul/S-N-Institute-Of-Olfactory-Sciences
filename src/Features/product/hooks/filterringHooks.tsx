...
import { useSearchParams } from "next/navigation"; // Next.js: baca filter awal dari query param
...
export const useProductFilters = (products: ProductType[]): ProductFiltersHookReturn => {
  const searchParams = useSearchParams(); // Next.js: query param (?type=Niche)
