...
Berikan minimal 4 strategi konkret dan realistis. Mulai langsung dengan { tanpa teks lain.`;
    ...
    try {
      // Panggil backend sebagai proxy — bukan langsung ke 9Router (hindari CORS)
      const res = await apiClient.post("/ai/sales-report", {
        prompt,
        days,
        growth,
      });
      ...
      if (!parsed) throw new Error("Response kosong dari server");
